...
# ================= Work directories =================
WORK_BASE=${WORK_BASE:-/cfs_turbo/yuleiqin/Research/SWE_code/verl_v0.7.0}
...
model_path=${MODEL_PATH:-/cfs_turbo/yuleiqin/models/Qwen3-4B-Instruct-2507}
...
rollout_data_dir=$default_local_dir/rollout
validation_data_dir=$default_local_dir/validation
